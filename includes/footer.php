        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <p>
                    <!-- p Starts -->
                    <strong></strong>
                    <br>nhung991@gmail.com
                    <br>Hòa Hải - Ngũ Hành Sơn - Đà Nẵng
                    <br>8801521328280
                    <br>
                    <strong></strong>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <h4>Đăng ký để cập nhật ưu đãi</h4>

                

                <form action="#" method="post" target="popupwindow" onsubmit="window.open('https://feedburner.google.com/fb/a/mailverify?uri=computerfever', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true">
                    <!-- form Starts -->
