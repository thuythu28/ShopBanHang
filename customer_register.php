    ...
    <div id="top">
        ...
        <div class="container">
            ...
            <div class="col-md-6 offer">
                ...
                <a href="#">
                    Tổng giá: <?php total_price(); ?>, Tổn hàng: <?php items(); ?>
                </a>
                ...
                <ul class="menu">
                    ...
                    <li>
                        ...
                        if (!isset($_SESSION['customer_email'])) {
                            ...
                            echo "<a href='logout.php'> Đăng suất</a>";
                        }
...
if (isset($_POST['register'])) {
    ...
    if ($check_email == 1) {
        ...
        echo "<script>alert('Email này đã được đăng ký, hãy thử một email khác')</script>";
