...
<label class="col-md-3 control-label">Thêm người dùng </label>
...
<label class="col-md-3 control-label"> Email người dùng: </label>
...
<label class="col-md-3 control-label">Mật khẩu người dùng: </label>
...
<label class="col-md-3 control-label">Công việc người dùng: </label>
...
<label class="col-md-3 control-label">Số điện: </label>
...
<label class="col-md-3 control-label">Chi tiết người dùng: </label>
...
echo "<script>alert('Một người dùng đã được thêm thành công')</script>";
